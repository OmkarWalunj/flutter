...
class AuthProvider extends ChangeNotifier {
  ...
  Future<void> updateProfile(BuildContext context, String name, String bio, File? profilePic) async {
    try {
      _isLoading = true;
      notifyListeners();
      ...
      if (profilePic != null) {
        String imageUrl = await storeFileToStorage("profilePic/${currentUser.uid}", profilePic);
        _userModel!.profilePic = imageUrl;
      }

      // Update user data in Firestore
      await _firebaseFirestore.collection("users").doc(currentUser.uid).update(_userModel!.toMap());
