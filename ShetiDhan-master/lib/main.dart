...
void main() async{
  ...
  // Initialize and configure flutterLocalNotificationsPlugin...

  // Pass flutterLocalNotificationsPlugin to firebaseCloudMessagingListeners
  //firebaseCloudMessagingListeners(flutterLocalNotificationsPlugin);
  runApp(const MyApp());
}
